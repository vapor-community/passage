...
struct IdentityRouteCollectionTests {
    ...
    @Test("IdentityRouteCollection initialization with default routes")
    func routeCollectionInitialization() {
        let routes = Passage.Configuration.Routes()
        let collection = IdentityRouteCollection(routes: routes)
    ...
    @Test("IdentityRouteCollection initialization with custom routes")
    ...
    @Test("IdentityRouteCollection stores routes configuration")
    ...
    @Test("IdentityRouteCollection conforms to RouteCollection")
    ...
    @Test("IdentityRouteCollection with no group")
    ...
    @Test("IdentityRouteCollection with auth group")
    ...
    @Test("IdentityRouteCollection with nested group")
    ...
    @Test("IdentityRouteCollection with versioned group")
    ...
    @Test("IdentityRouteCollection default route paths")
    ...
    @Test("IdentityRouteCollection with custom path components")
    ...
    @Test("IdentityRouteCollection preserves route configuration")
    ...
    @Test("IdentityRouteCollection can be instantiated multiple times")
    func multipleRouteCollectionInstances() {
        ...
        let collection1 = IdentityRouteCollection(routes: routes1)
        let collection2 = IdentityRouteCollection(routes: routes2)
    ...
    @Test("IdentityRouteCollection instances are independent")
